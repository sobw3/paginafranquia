        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-5xl md:text-7xl font-black font-heading italic uppercase leading-none mb-8 tracking-tighter text-white">
              ...
              <div className="bg-white/5 p-6 rounded-3xl border-l-4 border-l-orange-500">
